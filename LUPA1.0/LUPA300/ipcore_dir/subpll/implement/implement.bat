...
xst -ifn xst.scr
move subpll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\subpll.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc subpll.ucf subpll_exdes

echo 'Running map'
map -timing -pr b subpll_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm subpll_exdes -w routed.ncd routed.v
cd ..
