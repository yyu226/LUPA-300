...
xst -ifn xst.scr
move cmm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\cmm.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc cmm.ucf cmm_exdes

echo 'Running map'
map -timing -pr b cmm_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm cmm_exdes -w routed.ncd routed.v
cd ..
